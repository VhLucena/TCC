...
\input{3.FundamentacaoTeorica/kdd.tex}

% --- Ensemble --- %
\input{3.FundamentacaoTeorica/ensemble.tex}

% --- Florestas Aleatórias --- %
\input{3.FundamentacaoTeorica/florestas.tex}

% --- Adaboost --- %
\input{3.FundamentacaoTeorica/adaboost.tex}

% --- Support Vector Machine --- %
\input{3.FundamentacaoTeorica/svm.tex}